...
<head>
    ...
    <script>
        ...
        // 공지사항 게시글 작성자 아이디
        const user_id = "<%=CmmUtil.nvl(rDTO.getToMail())%>";

        // 현재 글번호, 자바에서 받을 변수들은 자바스크립트 변수로 저장하면 편함
        const nSeq = "<%=CmmUtil.nvl(rDTO.getTitle())%>";
...
<div class="divTable minimalistBlack">
    <div class="divTableBody">
        ...
        <div class="divTableRow">
            <div class="divTableCell">수신인
            </div>
            <div class="divTableCell"><%=CmmUtil.nvl(rDTO.getToMail())%>
            </div>
        </div>
        <div class="divTableRow">
            <div class="divTableCell">발송일
            </div>
